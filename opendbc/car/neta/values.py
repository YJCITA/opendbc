...
from opendbc.car import AngleSteeringLimits, CarSpecs, PlatformConfig, Platforms, CanBusBase, DbcDict, Bus, Platforms
from opendbc.car.docs_definitions import CarHarness, CarDocs
...
class CAR(Platforms):
  config: NetaPlatformConfig
  NETA_L_ARS513 = NetaPlatformConfig(
      [CarDocs("NETA L ARS513", "All")],
      CarSpecs(mass=2070, wheelbase=2.81, steerRatio=15.84),
  )
  NETA_L_CH = NetaPlatformConfig(
      [CarDocs("NETA L CH", "All")],
      CarSpecs(mass=2070, wheelbase=2.81, steerRatio=15.84),
  )
  NETA_L_VISION = NetaPlatformConfig(
