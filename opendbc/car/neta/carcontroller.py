...
from opendbc.car import Bus, apply_driver_steer_torque_limits, apply_std_steer_angle_limits
from opendbc.car.interfaces import CarControllerBase
from opendbc.car.neta import neta_s_canfd
from opendbc.car.neta.values import CanBus, CarControllerParams, NETA_CARS
...
class CarController(CarControllerBase):
  ...
  def update_control_neta_s(self, CC, CC_SP, CS, now_nanos):
    ...
    if self.CP.openpilotLongitudinalControl:
      ...
      accel_cmd = np.clip(actuators.accel, self.CCP.ACCEL_MIN, self.CCP.ACCEL_MAX)
      ...
      standstill_for_lat_control = CS.out.standstill
