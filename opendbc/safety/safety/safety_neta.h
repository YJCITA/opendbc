...
const AngleSteeringLimits NETA_STEERING_LIMITS = {
...
//  trans 2 ---> 0
static const CanMsg NETA_STOCK_TX_MSGS[] = { {0x8f, 0, 32, true}, {0xfe, 0, 32, true}, {0x190, 0, 64, true}, {0x191, 0, 64, true}, {0x192, 0, 64, true}, {0x194, 0, 64, true},
                                              {0x210, 0, 8, true}, {0x255, 0, 8, true}, {0x265, 0, 8, true}, {0x301, 0, 8, true}, {0x607, 0, 8, true},
                                              {0x8f, 2, 32, false}, {0xfe, 2, 32, false}, {0x190, 2, 64, false}, {0x191, 2, 64, false}, {0x192, 2, 64, false},  {0x194, 2, 64, false},
                                              {0x210, 2, 8, false}, {0x255, 2, 8, false}, {0x265, 2, 8, false}, {0x301, 2, 8, false}, {0x607, 2, 8, false} };
...
static safety_config neta_init(uint16_t param) {
  UNUSED(param);
  return neta_longitudinal ? BUILD_SAFETY_CFG(neta_rx_checks, NETA_LONG_TX_MSGS) : \
                                   BUILD_SAFETY_CFG(neta_rx_checks, NETA_STOCK_TX_MSGS);
}
